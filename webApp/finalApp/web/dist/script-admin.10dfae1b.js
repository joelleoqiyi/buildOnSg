...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script-admin.js":[function(require,module,exports) {
// this happens when user presses 'sign in'
function submitAdmin() {
  //alert('cool')
  adminUser = document.getElementById('admin-user').value;
  adminPassword = document.getElementById('admin-password').value; //checks if all the information is filled out
  ...
  fetch('http://buildonsg-tracelet.us-east-1.elasticbeanstalk.com/login/staff', {
    ...
    return alert("Oh no something went wrong! ".concat(err));
  });
}
...
},{}]},{},["../../../../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","script-admin.js"], null)
//# sourceMappingURL=./script-admin.10dfae1b.js.map