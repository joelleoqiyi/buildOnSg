...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script-template.js":[function(require,module,exports) {
...
window.addEventListener('DOMContentLoaded', function () {
  fetch("http://buildonsg-tracelet.us-east-1.elasticbeanstalk.com/snapshot/REQ", {
    ...
    alert("Something went wrong. Please try again! Error Message: ".concat(err));
  });
  document.getElementById('publish').addEventListener('click', function () {
    var snapshot_view = document.getElementById('view').innerHTML;
    console.log(snapshot_view);
    fetch("http://buildonsg-tracelet.us-east-1.elasticbeanstalk.com/snapshot/UPDATE", {
      "method": "POST",
      "headers": {
        "Content-Type": "application/json"
      },
...
},{}]},{},["../../../../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","script-template.js"], null)
//# sourceMappingURL=./script-template.512098ad.js.map