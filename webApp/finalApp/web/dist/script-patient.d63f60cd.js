...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script-patient.js":[function(require,module,exports) {
var received = null;
...
function patientSignIn() {
  ...
  var patientName = document.getElementById('patient-name').value; //checks if all the information is filled out
  ...
  fetch("http://buildonsg-tracelet.us-east-1.elasticbeanstalk.com/login/patient", {
    ...
    if (data.length > 0) {
      msg.textContent = '';
      var detailBox = document.getElementById('login-box');
      detailBox.classList.remove('login-box');
      detailBox.classList.add('login-box-patient');
      document.getElementById('patient-id').value = "Ward Number: ".concat(data[0].ward);
      document.getElementById('patient-name').value = "Bed Number: ".concat(data[0].bed);
...
function submitPaitent() {
  ...
  console.log(value);
  alert('Changes made is successful!'); // window.location.href="https://a-1-test-1.rea123.repl.co/index.html" //update this
}
...
},{}]},{},["../../../../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","script-patient.js"], null)
//# sourceMappingURL=./script-patient.d63f60cd.js.map